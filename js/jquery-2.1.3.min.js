...
!(function (a, b) {
  ...
  n.fn = n.prototype = {
    ...
    eq(a) { const b = this.length; const c = +a + (a < 0 ? b : 0); return this.pushStack(c >= 0 && b > c ? [this[c]] : []); },
  ...
  n.extend = n.fn.extend = function () {
    ...
    for (typeof g === 'boolean' && (j = g, g = arguments[h] || {}, h++),
    typeof g === 'object' || n.isFunction(g) || (g = {}), h === i && (g = this, h--);
      i > h; h++) {
